...
public interface Simple2Listener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterBoolExp(Simple2Parser.BoolExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code boolExp}
	 * labeled alternative in {@link Simple2Parser#exp}.
	 * @param ctx the parse tree
	 */
	void exitBoolExp(Simple2Parser.BoolExpContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterNotExp(Simple2Parser.NotExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code notExp}
	 * labeled alternative in {@link Simple2Parser#exp}.
	 * @param ctx the parse tree
	 */
	void exitNotExp(Simple2Parser.NotExpContext ctx);
}